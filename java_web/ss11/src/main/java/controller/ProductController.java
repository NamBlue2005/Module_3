...
public class ProductController extends HttpServlet {
    ...
    private void createProduct(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        try {
            ...
            Product newProduct = new Product(productService.generateId(), name, price, description, producer);
    ...
    private void updateProduct(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        try {
            ...
            Product updatedProduct = new Product(id, name, price, description, producer);
